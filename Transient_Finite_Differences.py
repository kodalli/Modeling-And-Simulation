...
def other(Fo, Bi, Tinf, Ts, To):
    T1 = oneb(Fo, Bi, Tinf, (To[0], To[1], To[4]))
    T2 = T5 = twob(Fo, Bi, Tinf, (To[1], To[5], To[0], To[2]))
    T9 = T3 = twob(Fo, Bi, Tinf, (To[2], To[6], To[1], To[3]))
    T6 = fourb(Fo, Bi, (To[5], To[1], To[4], To[6], To[9]))
    T13 = T4 = twob(Fo, Bi, Tinf, (To[3], To[7], To[2], Ts))
    T10 = T7 = fourb(Fo, Bi, (To[6], To[2], To[5], To[7], To[10]))
    T14 = T8 = fourb(Fo, Bi, (To[7], To[3], To[6], To[11], Ts))
    T11 = fourb(Fo, Bi, (To[10], To[6], To[9], To[11], To[14]))
    T15 = T12 = fourb(Fo, Bi, (To[11], To[7], To[10], To[15], Ts))
...
if __name__ == "__main__":
    ...
    print(To)
    temp = other(Fo, Bi, Tinf, Ts, To)
    for _ in range(int(t/dt)-1):
        # print(temp)
        temp = other(Fo, Bi, Tinf, Ts, temp)
    for i in range(4):
        print(temp[i], temp[i+1], temp[i+2], temp[i+3])
    pass
